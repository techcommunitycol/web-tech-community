        ...
        {MILESTONES.map((m, i) => {
          ...
          return (
            <div key={m.year} className="relative text-center">
              <div className="mx-auto h-10 w-10 rounded-full bg-primary ring-4 ring-gray-200 shadow-md grid place-items-center">
        ...
        {MILESTONES.map((m, i) => {
          ...
          return (
            <div key={m.year} className="relative pl-10">
              <div className="absolute left-1.5 top-2 h-6 w-6 rounded-full bg-primary ring-2 ring-gray-200 grid place-items-center">
